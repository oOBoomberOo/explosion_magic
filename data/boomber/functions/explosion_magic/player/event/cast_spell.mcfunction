...
execute if score #bb.em.spell bb.variable = #bb.em.bool.false bb.enum if predicate boomber:explosion_magic/spell/miniature_explosion run function boomber:explosion_magic/spell/miniature_explosion/fire
